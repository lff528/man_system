      ...
      children:[
          {
            path: '/zhinengsuokong',
            name: 'zhinengsuokong',
            component: resolve => require(['@/view/xitongpeizhi/zhinengsuokong'], resolve),
            title:'智能锁控首页'
          },
          {
            path: '/renwushouquan',
            name: 'renwushouquan',
            component: resolve => require(['@/view/xitongpeizhi/renwushouquan'], resolve),
            title:'任务授权'
          },
          {
            path: '/lishichaxun',
            name: 'lishichaxun',
            component: resolve => require(['@/view/xitongpeizhi/lishichaxun'], resolve),
            title:'历史查询'
          },
          {
            path: '/suokongquanxianshezhi',
            name: 'suokongquanxianshezhi',
            component: resolve => require(['@/view/xitongpeizhi/suokongquanxianshezhi'], resolve),
            title:'锁控权限设置'
          }
      ]
    }
