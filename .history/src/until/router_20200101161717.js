      ...
      children:[
          {
            ...
            },
            {
              path: '/jishui',
              name: 'jishui',
              component: resolve => require(['@/view/huanjingjiankong/jishui'], resolve),
              title:'空调暖通系统'
            },
            {
              path: '/paishui',
              name: 'paishui',
              component: resolve => require(['@/view/huanjingjiankong/paishui'], resolve),
              title:'生产综合楼'
            },
            {
              path: '/yuzhishezhi',
              name: 'yuzhishezhi',
              component: resolve => require(['@/view/huanjingjiankong/yuzhishezhi'], resolve),
              title:'站区气象'
            },
